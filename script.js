onload = function () {
    ...
    const cities = ['HOME', 'Mumbai', 'Gorakhpur', 'Lucknow', 'Kanpur', 'Delhi', 'Hyderabad', 'Bangalore', 'Gangtok', 'Meghalaya'];
    ...
    function createData(){
        V = Math.floor(Math.random() * 8) + 5; // Ensures V is between 3 and 10
        let nodes = [];
        for(let i=1;i<=V;i++){
